...
//            else
//            {
//                ModelState.AddModelError("Test", "Tên tài khoản đã tồn tại. Vui lòng chọn tài khoản khác.");
//            }
//            return View(user);
...
//                db.Entry(model).State = EntityState.Modified;
//                db.SaveChanges();
//                return Json(new { price = model.total_price.ToString(), quantity = model.tbl_cartDetail.Select(x => x.quantity).Count(), priceRemove = 0 - priceRemove, quantityRemove = 0 - quantityRemove }, JsonRequestBehavior.AllowGet);
//            }
//            catch
//            {
//                return null;
